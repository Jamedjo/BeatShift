...
namespace ContentPipelineProject
{
    ...
    public class BShiftAdvancedModelProcessor : BShiftModelProcessor
    {
        ...
        /// <summary>
    /// Import a model including vertex and indice data for BePU physics, and animation data for level transisions.
    /// </summary>
    [ContentProcessor(DisplayName = "BeatShift Animated Ship Processor")]
    public class AnimatedShipModelProcessor : BShiftModelProcessor
    {
        public override ModelContent Process(NodeContent input,
                                             ContentProcessorContext context)
        {
