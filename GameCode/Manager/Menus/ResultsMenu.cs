            ...
            else if (Race.currentRaceType.getRaceTypeString().Equals("TimeTrialRace"))
            {
                ...
                for (int i = 0; i < Race.currentRacers.Count; i++)
                {
                    if (Race.currentRacers[i].raceTiming.fastestLap.TotalMilliseconds < MapManager.currentMap.timeTrialRanks[0])
                        DrawMessageColour(BeatShift.newfont, Race.currentRacers[i].racerID.ToString() + " " + Race.currentRacers[i].raceTiming.getBestLapTime(), 500 + offset, 150, 0.7f, Color.Aqua);
                        ...
                        DrawMessageColour(BeatShift.newfont, Race.currentRacers[i].racerID.ToString() + " " + Race.currentRacers[i].raceTiming.getBestLapTime(), 500 + offset * 2, 150, 0.7f, Color.Goldenrod);
                        ...
                        DrawMessageColour(BeatShift.newfont, Race.currentRacers[i].racerID.ToString() + " " + Race.currentRacers[i].raceTiming.getBestLapTime(), 500 + offset * 3, 150, 0.7f, Color.White);
                        ...
                        DrawMessageColour(BeatShift.newfont, Race.currentRacers[i].racerID.ToString() + " " + Race.currentRacers[i].raceTiming.getBestLapTime(), 500 + offset * 4, 150, 0.7f, Color.SaddleBrown);
                        ...
                        DrawMessageColour(BeatShift.newfont, Race.currentRacers[i].racerID.ToString() + " Unranked", 500 + offset * i, 150, 0.7f, Color.Gainsboro);
