...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    public class BeatGlowParticleSystem : DefaultSprite3DBillboardParticleSystem
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
        {
            ...
            InitializeSpriteParticleSystem(cGraphicsDevice, cContentManager, 200, 5000, "Particles/New/BeatGlow");
        ...
        public void Glow(Color GlowColor, Vector3 shipPosition, Vector3 shipVelocity)
        {
            Emitter.PositionData.Position = shipPosition;
            InitialProperties.StartColorMax = GlowColor;
